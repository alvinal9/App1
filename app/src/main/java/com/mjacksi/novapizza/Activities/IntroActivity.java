...
public class IntroActivity extends AppIntro {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sliderPage2.setImageDrawable(R.drawable.baseline_delivery_dining_24);
        ...
        sliderPage4.setDescription("Our app allows you to see your order status and orders history!");
        sliderPage4.setImageDrawable(R.drawable.orders);
